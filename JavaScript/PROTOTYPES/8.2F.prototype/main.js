...
alert( rabbit.eats ); // true т.к. полностью заменен прототип и это уже не влияет на ранее созданный объект
...
alert( rabbit.eats ); // false, т.к. ссылается на измененный Rabbit.prototype.eats = false - т.к. прототип не менялся, только его значение

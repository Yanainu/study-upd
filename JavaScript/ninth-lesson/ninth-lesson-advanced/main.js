...
// т.е. можно было вызывать их вот так: user.method1().method2().method3()... - я так поняла что решение в том, чтобы return this
//но как это детально работает чет в учебнике не сказано. ну он возвращает текущее состояние объекта, как я понимаю.
// и от текущего уже делается следующий метод. т.е. предыдущий не теряется. я так это поняла.
